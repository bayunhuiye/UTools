...
public class HighlightUtil
{
    ...
    {
        public ReferType type;
        public object refObj;

        public string referSceneName;
        public Transform referRoot;
        public GameObject referObj;
        public Component referScript;
        public MemberInfo referMember;
    }

    private static List<Result> results = new List<Result>();

    public static void HighlightRefer(
...
//                EditorGUIUtility.PingObject(firstResult.referObj);
    ...
    private static void LogResult()
    {
        ...
        {
            var path = PathUtil.GetTransformTreePath(
    ...
    public static void FindRefInGameObject(
        GameObject referObj,
        object refObj,
        Transform referRoot,
    ...
    )
    {
        ...
        {
            var isPrefabInstance = EdUtil.IsPrefabInstance(referObj);
            if (isPrefabInstance)
            {
    ...
    public static void FindRefInComponent(
        Component m,
        object refObj,
        Transform referRoot,
        string referSceneName
    ...
    public static void FindRefInField(
        Component m,
    ...
    public static bool IsDriverFrom(Type subType, Type targetType)
    {
