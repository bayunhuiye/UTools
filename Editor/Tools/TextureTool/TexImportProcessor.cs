...
public class TexImportProcessor : AssetPostprocessor
{
    ...
    public static TexImporterSetting.Settings GetSettings(
    ...
    public static bool CheckSpecialItemMatch(
    ...
    public static TexImporterSetting FirstSetting(string dirPath)
    {
        ...
        var asset = EdUtil.FindScriptableObject<TexImporterSetting>(dirPath, false);
